...
public class ImporterTest extends ClientBaseTest {
    ...
    public final void testAsyncLaf9ImportSuccess()
        ...
        // Existing measFacil tag gets validity extended
        Tag existingMeasFacilTag = new Tag();
        existingMeasFacilTag.setName("not associated measFacil tag");
        existingMeasFacilTag.setMeasFacilId(mstId);
        laf.getTags().add(existingMeasFacilTag);
        ...
        expected.getTags().add(1, existingMeasFacilTag);
    ...
    private Sample prepareLaf9Data() {
        ...
        // Existing global tag can be associated
        Tag existingTag = new Tag();
        existingTag.setName(existingNotAssociatedTag);
