 ...
 */
@Entity
@Table(name="audit_trail_messprogramm", schema = SchemaName.NAME)
@TypeDefs({ @TypeDef(name = "JsonObject", typeClass = JsonObjectType.class) })
public class AuditTrailMessprogramm implements Serializable {
