 ...
 */
public class NoUnnecessaryReiAttributesValidator
    implements ConstraintValidator<NoUnnecessaryReiAttributes, Sample> {
    ...
    @Override
    public void initialize(NoUnnecessaryReiAttributes constraintAnnotation) {
