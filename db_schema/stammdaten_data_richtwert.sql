...
--
-- Data for Name: richtwert_massnahme; Type: TABLE DATA; Schema: stamm; Owner: postgres
--

COPY stamm.richtwert_massnahme (id, massnahme, beschreibung) FROM stdin;
...
--
-- Data for Name: richtwert; Type: TABLE DATA; Schema: stamm; Owner: postgres
--

COPY stamm.richtwert (id, umw_id, massnahme_id, messgroessengruppe_id, zusatztext, richtwert) FROM stdin;
235	N11	9	30	\N	125
236	N12	9	30	\N	125
237	N13	9	30	\N	125
238	N21	9	30	\N	750
...
--
-- Name: richtwert_id_seq; Type: SEQUENCE SET; Schema: stamm; Owner: postgres
--

SELECT pg_catalog.setval('stamm.richtwert_id_seq', 479, true);


--
-- Name: richtwert_massnahme_id_seq; Type: SEQUENCE SET; Schema: stamm; Owner: postgres
--

SELECT pg_catalog.setval('stamm.richtwert_massnahme_id_seq', 21, true);
