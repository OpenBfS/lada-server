...
CREATE TABLE site (
    ...
    coord_x_ext character varying(22) NOT NULL CHECK (trim(both ' ' from coord_x_ext) <> '') NOT NULL,
    coord_y_ext character varying(22) NOT NULL CHECK (trim(both ' ' from coord_y_ext) <> '') NOT NULL,
    alt real,
    last_mod timestamp without time zone DEFAULT (now() AT TIME ZONE 'utc'),
