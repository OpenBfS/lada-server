...
ALTER TABLE IF EXISTS lada.messprogramm_mmt_view RENAME TO mpg_mmt_mp_view;
ALTER TABLE IF EXISTS lada.mpg_mmt_mp_view RENAME COLUMN netzbetreiber_id TO network_id;
ALTER TABLE IF EXISTS lada.mpg_mmt_mp_view RENAME COLUMN messprogramm_id TO mpg_id;
ALTER TABLE IF EXISTS lada.mpg_mmt_mp_view RENAME COLUMN messgroessen TO measd;
ALTER TABLE IF EXISTS lada.mpg_mmt_mp_view RENAME COLUMN letzte_aenderung TO last_mod;
...
ALTER TABLE IF EXISTS lada.messprogramm_view RENAME TO mpg_view;
ALTER TABLE IF EXISTS lada.mpg_view RENAME COLUMN netzbetreiber_id TO network_id;
ALTER TABLE IF EXISTS lada.mpg_view RENAME COLUMN kommentar TO comm_mpg_view;
ALTER TABLE IF EXISTS lada.mpg_view RENAME COLUMN test TO is_test;
ALTER TABLE IF EXISTS lada.mpg_view RENAME COLUMN aktiv TO is_active;
ALTER TABLE IF EXISTS lada.mpg_view RENAME COLUMN mst_id TO meas_facil_id;
ALTER TABLE IF EXISTS lada.mpg_view RENAME COLUMN labor_mst_id TO appr_lab_id;
ALTER TABLE IF EXISTS lada.mpg_view RENAME COLUMN datenbasis_id TO regulation_id;
ALTER TABLE IF EXISTS lada.mpg_view RENAME COLUMN ba_id TO opr_mode_id;
ALTER TABLE IF EXISTS lada.mpg_view RENAME COLUMN media_desk TO env_descrip_id;
ALTER TABLE IF EXISTS lada.mpg_view RENAME COLUMN umw_id TO env_medium_id;
ALTER TABLE IF EXISTS lada.mpg_view RENAME COLUMN probenart_id TO sample_meth_id;
ALTER TABLE IF EXISTS lada.mpg_view RENAME COLUMN probenintervall TO sample_pd;
ALTER TABLE IF EXISTS lada.mpg_view RENAME COLUMN teilintervall_von TO sample_pd_start_date;
ALTER TABLE IF EXISTS lada.mpg_view RENAME COLUMN teilintervall_bis TO sample_pd_end_date;
ALTER TABLE IF EXISTS lada.mpg_view RENAME COLUMN intervall_offset TO sample_pd_offset;
ALTER TABLE IF EXISTS lada.mpg_view RENAME COLUMN gueltig_von TO valid_start_date;
ALTER TABLE IF EXISTS lada.mpg_view RENAME COLUMN gueltig_bis TO valid_end_date;
ALTER TABLE IF EXISTS lada.mpg_view RENAME COLUMN probe_nehmer_id TO sampleer_id;
ALTER TABLE IF EXISTS lada.mpg_view RENAME COLUMN mpl_id TO state_mpg_id;
ALTER TABLE IF EXISTS lada.mpg_view RENAME COLUMN probe_kommentar TO comm_sample;
ALTER TABLE IF EXISTS lada.mpg_view RENAME COLUMN rei_progpunkt_grp_id TO rei_ag_gr_id;
ALTER TABLE IF EXISTS lada.mpg_view RENAME COLUMN kta_gruppe_id TO nucl_facil_gr_id;
ALTER TABLE IF EXISTS lada.mpg_view RENAME COLUMN meh_id TO unit_id;
ALTER TABLE IF EXISTS lada.mpg_view RENAME COLUMN probenahmemenge TO sample_quant;
ALTER TABLE IF EXISTS lada.mpg_view RENAME COLUMN letzte_aenderung TO last_mod;
...
ALTER TABLE IF EXISTS lada.geolocat RENAME COLUMN ort_id TO site_ext_id;
...
ALTER TABLE IF EXISTS lada.ortszuordnung_mp_view RENAME TO geolocat_mpg_view;
ALTER TABLE IF EXISTS lada.geolocat_mpg_view RENAME COLUMN netzbetreiber_id TO network_id;
ALTER TABLE IF EXISTS lada.geolocat_mpg_view RENAME COLUMN messprogramm_id TO mpg_id;
ALTER TABLE IF EXISTS lada.geolocat_mpg_view RENAME COLUMN ort_id TO site_id;
ALTER TABLE IF EXISTS lada.geolocat_mpg_view RENAME COLUMN ortszuordnung_typ TO type_regulation;
ALTER TABLE IF EXISTS lada.geolocat_mpg_view RENAME COLUMN ortszusatztext TO add_site_text;
ALTER TABLE IF EXISTS lada.geolocat_mpg_view RENAME COLUMN letzte_aenderung TO last_mod;
...
ALTER TABLE IF EXISTS master.dom RENAME TO idf_dom;
ALTER TABLE IF EXISTS master.idf_dom RENAME COLUMN code_dom TO id;
ALTER TABLE IF EXISTS master.idf_dom RENAME COLUMN duration TO durat;
ALTER TABLE IF EXISTS master.idf_dom RENAME COLUMN duration_unit TO durat_unit;
ALTER TABLE IF EXISTS master.idf_dom RENAME COLUMN envmedium TO env_medium;
ALTER TABLE IF EXISTS master.idf_dom RENAME COLUMN duration_text TO durat_text;
ALTER TABLE IF EXISTS master.idf_dom RENAME COLUMN idf_nuclide TO measd_idf_nucl_mp_id;
...
ALTER TABLE IF EXISTS master.envmedium RENAME TO idf_env_medium;
ALTER TABLE IF EXISTS master.idf_env_medium RENAME COLUMN code TO id;
ALTER TABLE IF EXISTS master.idf_env_medium RENAME COLUMN envmedium_text TO text;
...
ALTER TABLE IF EXISTS master.munic_div RENAME COLUMN ozk_id TO site_ext_id;
...
ALTER TABLE IF EXISTS master.idf_country RENAME COLUMN code TO id;
ALTER TABLE IF EXISTS master.idf_country RENAME COLUMN idf_country TO name;
ALTER TABLE IF EXISTS master.idf_country RENAME COLUMN idf_country_ge TO idf_country_ger;
CREATE VIEW stamm.idf_country AS SELECT
	name AS idf_country,
	idf_country_ger AS idf_country_ge
FROM master.idf_country;

ALTER TABLE IF EXISTS master.idf_lada_translation RENAME TO idf_lada_mp;
ALTER TABLE IF EXISTS master.idf_lada_mp RENAME COLUMN umw_id TO env_medium_id;
ALTER TABLE IF EXISTS master.idf_lada_mp RENAME COLUMN mst_id TO meas_facil_id;
ALTER TABLE IF EXISTS master.idf_lada_mp RENAME COLUMN validated_status_kombi TO val_status_comb;
ALTER TABLE IF EXISTS master.idf_lada_mp RENAME COLUMN faktor TO factor;
ALTER TABLE IF EXISTS master.idf_lada_mp RENAME COLUMN meh_id TO unit_id;
...
ALTER TABLE IF EXISTS master.idf_network RENAME TO idf_grid_oper;
ALTER TABLE IF EXISTS master.idf_grid_oper RENAME COLUMN network_id TO id;
ALTER TABLE IF EXISTS master.idf_grid_oper RENAME COLUMN network TO name;
...
ALTER TABLE IF EXISTS master.nuclide RENAME TO measd_idf_nucl_mp;
ALTER TABLE IF EXISTS master.measd_idf_nucl_mp RENAME COLUMN code TO id;
ALTER TABLE IF EXISTS master.measd_idf_nucl_mp RENAME COLUMN nuclide TO measd;
ALTER TABLE IF EXISTS master.measd_idf_nucl_mp RENAME COLUMN nuclide_text TO text;
ALTER TABLE IF EXISTS master.measd_idf_nucl_mp RENAME COLUMN idf_nuklid_key TO idf_ext_id;
...
ALTER TABLE IF EXISTS master.nuts RENAME COLUMN nuts_code TO id;
ALTER TABLE IF EXISTS master.nuts RENAME COLUMN staat_id TO state_id;
ALTER TABLE IF EXISTS master.nuts RENAME COLUMN bezeichnung TO name;
ALTER TABLE IF EXISTS master.nuts RENAME COLUMN kda_id TO spat_ref_sys_id;
ALTER TABLE IF EXISTS master.nuts RENAME COLUMN koord_x_extern TO x_coord_ext;
ALTER TABLE IF EXISTS master.nuts RENAME COLUMN koord_y_extern TO y_coord_ext;
...
ALTER TABLE IF EXISTS master.site RENAME COLUMN ort_id TO site_ext_id;
...
ALTER TABLE IF EXISTS master.ort_backup RENAME TO site_bak;
ALTER TABLE IF EXISTS master.site_bak RENAME COLUMN netzbetreiber_id TO network_id;
ALTER TABLE IF EXISTS master.site_bak RENAME COLUMN ort_id TO ext_id;
ALTER TABLE IF EXISTS master.site_bak RENAME COLUMN langtext TO long_text;
ALTER TABLE IF EXISTS master.site_bak RENAME COLUMN staat_id TO state_id;
ALTER TABLE IF EXISTS master.site_bak RENAME COLUMN gem_id TO munic_id;
ALTER TABLE IF EXISTS master.site_bak RENAME COLUMN unscharf TO is_fuzzy;
ALTER TABLE IF EXISTS master.site_bak RENAME COLUMN nuts_code TO nuts_id;
ALTER TABLE IF EXISTS master.site_bak RENAME COLUMN kda_id TO spat_ref_sys_id;
ALTER TABLE IF EXISTS master.site_bak RENAME COLUMN koord_x_extern TO x_coord_ext;
ALTER TABLE IF EXISTS master.site_bak RENAME COLUMN koord_y_extern TO y_coord_ext;
ALTER TABLE IF EXISTS master.site_bak RENAME COLUMN hoehe_land TO alt;
ALTER TABLE IF EXISTS master.site_bak RENAME COLUMN letzte_aenderung TO last_mod;
ALTER TABLE IF EXISTS master.site_bak RENAME COLUMN ort_typ TO site_class_id;
ALTER TABLE IF EXISTS master.site_bak RENAME COLUMN kurztext TO short_text;
ALTER TABLE IF EXISTS master.site_bak RENAME COLUMN berichtstext TO rei_report_text;
ALTER TABLE IF EXISTS master.site_bak RENAME COLUMN zone TO rei_zone;
ALTER TABLE IF EXISTS master.site_bak RENAME COLUMN sektor TO rei_sector;
ALTER TABLE IF EXISTS master.site_bak RENAME COLUMN zustaendigkeit TO rei_competence;
ALTER TABLE IF EXISTS master.site_bak RENAME COLUMN mp_art TO rei_opr_mode;
ALTER TABLE IF EXISTS master.site_bak RENAME COLUMN aktiv TO is_rei_active;
ALTER TABLE IF EXISTS master.site_bak RENAME COLUMN kta_gruppe_id TO nucl_facil_gr_id;
ALTER TABLE IF EXISTS master.site_bak RENAME COLUMN oz_id TO poi_id;
ALTER TABLE IF EXISTS master.site_bak RENAME COLUMN hoehe_ueber_nn TO height_asl;
ALTER TABLE IF EXISTS master.site_bak RENAME COLUMN rei_progpunkt_grp_id TO rei_ag_gr_id;
ALTER TABLE IF EXISTS master.site_bak RENAME COLUMN gem_unt_id TO munic_div_id;
...
ALTER TABLE IF EXISTS master.ort_backup_mgrs RENAME TO site_bak_mgrs;
ALTER TABLE IF EXISTS master.site_bak_mgrs RENAME COLUMN netzbetreiber_id TO network_id;
ALTER TABLE IF EXISTS master.site_bak_mgrs RENAME COLUMN ort_id TO ext_id;
ALTER TABLE IF EXISTS master.site_bak_mgrs RENAME COLUMN langtext TO long_text;
ALTER TABLE IF EXISTS master.site_bak_mgrs RENAME COLUMN staat_id TO state_id;
ALTER TABLE IF EXISTS master.site_bak_mgrs RENAME COLUMN gem_id TO munic_id;
ALTER TABLE IF EXISTS master.site_bak_mgrs RENAME COLUMN unscharf TO is_fuzzy;
ALTER TABLE IF EXISTS master.site_bak_mgrs RENAME COLUMN nuts_code TO nuts_id;
ALTER TABLE IF EXISTS master.site_bak_mgrs RENAME COLUMN kda_id TO spat_ref_sys_id;
ALTER TABLE IF EXISTS master.site_bak_mgrs RENAME COLUMN koord_x_extern TO x_coord_ext;
ALTER TABLE IF EXISTS master.site_bak_mgrs RENAME COLUMN koord_y_extern TO y_coord_ext;
ALTER TABLE IF EXISTS master.site_bak_mgrs RENAME COLUMN hoehe_land TO alt;
ALTER TABLE IF EXISTS master.site_bak_mgrs RENAME COLUMN letzte_aenderung TO last_mod;
ALTER TABLE IF EXISTS master.site_bak_mgrs RENAME COLUMN ort_typ TO site_class_id;
ALTER TABLE IF EXISTS master.site_bak_mgrs RENAME COLUMN kurztext TO short_text;
ALTER TABLE IF EXISTS master.site_bak_mgrs RENAME COLUMN berichtstext TO rei_report_text;
ALTER TABLE IF EXISTS master.site_bak_mgrs RENAME COLUMN zone TO rei_zone;
ALTER TABLE IF EXISTS master.site_bak_mgrs RENAME COLUMN sektor TO rei_sector;
ALTER TABLE IF EXISTS master.site_bak_mgrs RENAME COLUMN zustaendigkeit TO rei_competence;
ALTER TABLE IF EXISTS master.site_bak_mgrs RENAME COLUMN mp_art TO rei_opr_mode;
ALTER TABLE IF EXISTS master.site_bak_mgrs RENAME COLUMN aktiv TO is_rei_active;
ALTER TABLE IF EXISTS master.site_bak_mgrs RENAME COLUMN kta_gruppe_id TO nucl_facil_gr_id;
ALTER TABLE IF EXISTS master.site_bak_mgrs RENAME COLUMN oz_id TO poi_id;
ALTER TABLE IF EXISTS master.site_bak_mgrs RENAME COLUMN hoehe_ueber_nn TO height_asl;
ALTER TABLE IF EXISTS master.site_bak_mgrs RENAME COLUMN rei_progpunkt_grp_id TO rei_ag_gr_id;
ALTER TABLE IF EXISTS master.site_bak_mgrs RENAME COLUMN gem_unt_id TO munic_div_id;
...
ALTER TABLE IF EXISTS master.ort_bb RENAME TO site_bb;
ALTER TABLE IF EXISTS master.site_bb RENAME COLUMN id TO site_id;
ALTER TABLE IF EXISTS master.site_bb RENAME COLUMN ort_typ TO site_class_id;
ALTER TABLE IF EXISTS master.site_bb RENAME COLUMN ort_id TO ext_id;
ALTER TABLE IF EXISTS master.site_bb RENAME COLUMN kurztext TO short_text;
ALTER TABLE IF EXISTS master.site_bb RENAME COLUMN langtext TO long_text;
...
ALTER TABLE IF EXISTS master.ort_bsh RENAME TO site_bsh;
ALTER TABLE IF EXISTS master.site_bsh RENAME COLUMN mst TO meas_facil_id;
ALTER TABLE IF EXISTS master.site_bsh RENAME COLUMN mst_labor TO appr_lab_id;
ALTER TABLE IF EXISTS master.site_bsh RENAME COLUMN netzbetreiber TO network;
ALTER TABLE IF EXISTS master.site_bsh RENAME COLUMN staat TO ctry;
ALTER TABLE IF EXISTS master.site_bsh RENAME COLUMN x_koordinate TO x_coord_ext;
ALTER TABLE IF EXISTS master.site_bsh RENAME COLUMN y_koordinate TO y_coord_ext;
ALTER TABLE IF EXISTS master.site_bsh RENAME COLUMN koordinatenart TO spat_ref_sys;
ALTER TABLE IF EXISTS master.site_bsh RENAME COLUMN ortsklassifizierung TO site_class_ext_id;
ALTER TABLE IF EXISTS master.site_bsh RENAME COLUMN ort_id TO site_ext_id;
ALTER TABLE IF EXISTS master.site_bsh RENAME COLUMN kurztext TO short_text;
ALTER TABLE IF EXISTS master.site_bsh RENAME COLUMN langtext TO long_text;
...
ALTER TABLE IF EXISTS master.ort_th RENAME TO site_th;
ALTER TABLE IF EXISTS master.site_th RENAME COLUMN ort_id TO id;
ALTER TABLE IF EXISTS master.site_th RENAME COLUMN bezeichnung TO descr;
ALTER TABLE IF EXISTS master.site_th RENAME COLUMN gem_id TO munic_id;
ALTER TABLE IF EXISTS master.site_th RENAME COLUMN mst TO meas_facil_id;
ALTER TABLE IF EXISTS master.site_th RENAME COLUMN hw TO gk_north;
ALTER TABLE IF EXISTS master.site_th RENAME COLUMN rw TO gk_east;
ALTER TABLE IF EXISTS master.site_th RENAME COLUMN ortszusatz TO poi;
ALTER TABLE IF EXISTS master.site_th RENAME COLUMN geo_h_w TO wgs_dez_north;
ALTER TABLE IF EXISTS master.site_th RENAME COLUMN geo_r_w TO wgs_dez_east;
ALTER TABLE IF EXISTS master.site_th RENAME COLUMN utm_ost TO utm_east;
ALTER TABLE IF EXISTS master.site_th RENAME COLUMN utm_nord TO utm_north;
ALTER TABLE IF EXISTS master.site_th RENAME COLUMN utm_32_ost TO utm_32_east;
ALTER TABLE IF EXISTS master.site_th RENAME COLUMN utm_32_nord TO utm_32_north;
...
ALTER TABLE IF EXISTS master.sampler RENAME COLUMN prn_id TO sampler_ext_id;
...
ALTER TABLE IF EXISTS master.query_messstelle_bak RENAME TO query_meas_facil_mp_bak;
ALTER TABLE IF EXISTS master.query_meas_facil_mp_bak RENAME COLUMN mess_stelle TO meas_facil_id;
...
ALTER TABLE IF EXISTS master.status_kombi_view RENAME TO status_mp_view;
ALTER TABLE IF EXISTS master.status_mp_view RENAME COLUMN kombi_id TO id;
ALTER TABLE IF EXISTS master.status_mp_view RENAME COLUMN kombi TO status_comb;
...
ALTER TABLE IF EXISTS master.unit RENAME TO meas_unit_dom;
ALTER TABLE IF EXISTS master.meas_unit_dom RENAME COLUMN code TO id;
ALTER TABLE IF EXISTS master.meas_unit_dom RENAME COLUMN unit TO unit_symbol;
ALTER TABLE IF EXISTS master.meas_unit_dom RENAME COLUMN unit_text TO name;
ALTER TABLE IF EXISTS master.meas_unit_dom RENAME COLUMN unit_eudf TO eudf_unit_id;
...
ALTER TABLE IF EXISTS master.user_overview RENAME TO user_overv_view;
ALTER TABLE IF EXISTS master.user_overv_view RENAME COLUMN netzbetreiber TO network;
ALTER TABLE IF EXISTS master.user_overv_view RENAME COLUMN mess_stelle TO meas_facil;
ALTER TABLE IF EXISTS master.user_overv_view RENAME COLUMN beschreibung TO meas_facil_addr;
ALTER TABLE IF EXISTS master.user_overv_view RENAME COLUMN labor_mst_id TO appr_lab_id;
ALTER TABLE IF EXISTS master.user_overv_view RENAME COLUMN funktion TO function;
ALTER TABLE IF EXISTS master.user_overv_view RENAME COLUMN ldap_group TO ldap_gr_uid;
...
ALTER TABLE IF EXISTS master.verwaltungseinheit_view RENAME TO admin_unit_view;
ALTER TABLE IF EXISTS master.admin_unit_view RENAME COLUMN bezeichnung TO admin_unit;
ALTER TABLE IF EXISTS master.admin_unit_view RENAME COLUMN regbezirk TO gov_dist_id;
ALTER TABLE IF EXISTS master.admin_unit_view RENAME COLUMN kreis TO rural_dist_id;
ALTER TABLE IF EXISTS master.admin_unit_view RENAME COLUMN bundesland TO state_id;
ALTER TABLE IF EXISTS master.admin_unit_view RENAME COLUMN is_gemeinde TO is_munic;
ALTER TABLE IF EXISTS master.admin_unit_view RENAME COLUMN is_landkreis TO is_rural_dist;
ALTER TABLE IF EXISTS master.admin_unit_view RENAME COLUMN is_regbezirk TO is_gov_dist;
ALTER TABLE IF EXISTS master.admin_unit_view RENAME COLUMN is_bundesland TO is_state;
ALTER TABLE IF EXISTS master.admin_unit_view RENAME COLUMN plz TO zip;
ALTER TABLE IF EXISTS master.admin_unit_view RENAME COLUMN mittelpunkt TO geom_center;
