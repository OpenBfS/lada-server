ALTER TABLE lada.mpg_mmt_mp_measd ADD measd_id_ integer;
UPDATE lada.mpg_mmt_mp_measd
    SET measd_id_ = (SELECT id_old FROM master.measd WHERE id = measd_id);
...
ALTER TABLE lada.meas_val ADD measd_id_ integer;
...
ALTER TABLE master.measd_gr_mp ADD measd_id_ integer;
...
ALTER TABLE master.oblig_measd_mp ADD measd_id_ integer;
...
ALTER TABLE master.measd RENAME id TO name;
ALTER TABLE master.measd RENAME id_old TO id;
ALTER TABLE master.measd
    DROP CONSTRAINT measd_pkey,
    DROP CONSTRAINT measd_id_old_key,
    ADD PRIMARY KEY (id),
    ADD UNIQUE (name),
